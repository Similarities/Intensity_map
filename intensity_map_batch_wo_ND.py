...
class Open_and_Plot_Picture:
        def __init__(self, filename,EL,GVD,filedescription):
...
class Batch_Baker:  
    ...
    def batch_energy_and_GVD(self):
        ...
        for i in range (0, 6):
            ...
            for i in range(1,6):
                ...
                string_value1 = str(x) + "J "+self.filedescription +"um"+ str(defocus) +"GVD"+str(self.GVD)
            
                Picture1=Open_and_Plot_Picture(self.filename, x, self.GVD, string_value1)
    ...
    def batch_GVD(self):
        ...
        for i in range (1, 6):
            ...
            string_value1 = str(self.EL) + "J "+self.filedescription   +"um"+ str(defocus)+"GVD"+str(self.GVD)
            
            print(string_value1, "string value")
            
            Picture1=Open_and_Plot_Picture(self.filename, self.EL, self.GVD, string_value1)
...
Batch_Baker1 = Batch_Baker("tiff/focus_tisa_-19720a_1.3ND_vac.tif",2.0,0.)
Batch_Baker1.batch_energy_and_GVD()
#Batch_Baker1.batch_energy()
#Batch_Baker1.batch_GVD()

#next time use the same dataset        ! Argumentuebergabe ! ueberschreiben! 
